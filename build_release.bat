...
echo ============================================
echo  UPS Power Monitor - Build Release v1.0.0
echo ============================================
...
mkdir release 2>nul
powershell -Command "Compress-Archive -Path 'dist\UPS Power Monitor\*' -DestinationPath 'release\UPS-Power-Monitor-v1.0.0-portable.zip' -Force"
echo ZIP created: release\UPS-Power-Monitor-v1.0.0-portable.zip
